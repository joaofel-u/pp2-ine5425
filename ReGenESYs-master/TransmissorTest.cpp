...
TransmissorTest::TransmissorTest() {}
TransmissorTest::TransmissorTest(const TransmissorTest& orig) {}
TransmissorTest::~TransmissorTest() {}
 ...
 */
int TransmissorTest::main(int argc, char** argv) {
    ...
    if (model->checkModel()) {
	model->saveModel("./temp/transmissorTest.txt");
    }
